...
function buildSidebar() {
  ...
  left.innerHTML = `
    ...
    <div class="sl-section">
      ...
      <button id="lx-nb-0" class="sl-btn on" onclick="lxNav('subjects')">
      ...
      <button id="lx-nb-1" class="sl-btn" onclick="lxNav('lesson')">
      ...
      <button id="lx-nb-2" class="sl-btn" onclick="lxNav('dual')">
      ...
      <button id="lx-nb-3" class="sl-btn" onclick="lxNav('games')">
      ...
      <button id="lx-nb-4" class="sl-btn" onclick="lxNav('profile')">
...
document.addEventListener('DOMContentLoaded', () => {
  buildSidebar();           // Must run BEFORE onResize
  onResize();               // Now sidebars exist, safe to show/hide
